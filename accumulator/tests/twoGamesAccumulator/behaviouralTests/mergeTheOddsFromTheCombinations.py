...
class MergeTheOddsFromTheCombinations(TestCase, TwoGamesAccumulator, GeneralGamesAccumulator):
    def setUp(self):
    ...
    def test_GettingTwoCombinedGamesFromIndex_0(self):
        self.assertEqual(Decimal('0.91'), self.get_all_odds_combo[0])

    def test_GettingTwoCombinedGamesFromIndex_1(self):
        self.assertEqual(Decimal('1.30'), self.get_all_odds_combo[1])

    def test_GettingTwoCombinedGamesFromIndex_2(self):
        self.assertEqual(Decimal('0.91'), self.get_all_odds_combo[2])

    def test_GettingTwoCombinedGamesFromIndex_3(self):
        self.assertEqual(Decimal('2.00'), self.get_all_odds_combo[3])

    def test_GettingTwoCombinedGamesFromIndex_4(self):
        self.assertEqual(Decimal('0.91'), self.get_all_odds_combo[4])

    def test_GettingTwoCombinedGamesFromIndex_5(self):
        self.assertEqual(Decimal('2.20'), self.get_all_odds_combo[5])
