...
class TestingConvertFractionToDecimal(TestCase, DecimalToFractionAndStoreInDb):
    ...
    def test_CheckThatTheLengthIsGreaterThan_0(self):
        self.assertGreater(len(self.get_converts), 0)

    def test_GetIndex_0_AndCheckThatItsElementIsAFloat(self):
        self.assertIsInstance(self.get_converts[0][0], float)

    def test_GetIndex_1_AndCheckThatItsElementIsAFloat(self):
        self.assertIsInstance(self.get_converts[0][1], float)

    def test_GetIndex_2_AndCheckThatItsElementIsAFloat(self):
        self.assertIsInstance(self.get_converts[0][2], float)

    def test_GetIndex_3_AndCheckThatItsElementIsAFloat(self):
        self.assertIsInstance(self.get_converts[1][0], float)

    def test_GetIndex_4_AndCheckThatItsElementIsAFloat(self):
        self.assertIsInstance(self.get_converts[1][1], float)

    def test_GetIndex_5_AndCheckThatItsElementIsAFloat(self):
