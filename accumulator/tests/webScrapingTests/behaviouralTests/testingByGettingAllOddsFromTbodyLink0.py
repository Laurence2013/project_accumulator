...
class TestingByGettingAllOddsFromTbodyLink0(TestCase, ScrapingWilliamHill):
    def setUp(self):
        ...
        self.tbody_ids_link_0_odds = base_dir + '/accumulator/tests/webScrapingTests/testingFiles/tbody_link_0_odds.csv'
        self.tbody_ids_link_1_odds = base_dir + '/accumulator/tests/webScrapingTests/testingFiles/tbody_link_1_odds.csv'
