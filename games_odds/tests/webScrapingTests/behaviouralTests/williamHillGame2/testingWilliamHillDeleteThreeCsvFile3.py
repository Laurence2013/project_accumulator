...
This is testing the refresh_no sent, sending 1 and emptying three files -> get_match_odds_link_0.csv and ids_for_tag_span_link_0.csv and ids_for_tag_tbody_link_0.csv
Then refresh page with refresh_no 1
'''

class TestingWilliamHillDeleteThreeCsvFile3(TestCase, MainViewsApi, WilliamHillBase, ScrapingWilliamHill):
    def setUp(self):
    ...
    def test_02_empty_2b_file_is_true(self):
        my_file = list()
        get_match_odds_link_1 = self.base_dir + '/games_odds/williamHillFiles/tag_name_span_attr_ids/ids_for_tag_span_link_1.csv'
        my_file.append(get_match_odds_link_1)
        is_empty_file = self.empty_files(my_file)
        self.assertTrue(is_empty_file)
    ...
    def test_03_empty_2b_file_is_true(self):
        my_file = list()
        get_match_odds_link_1 = self.base_dir + '/games_odds/williamHillFiles/tag_name_tbody_attr_ids/ids_for_tag_tbody_link_1.csv'
        my_file.append(get_match_odds_link_1)
        is_empty_file = self.empty_files(my_file)
        self.assertTrue(is_empty_file)
    ...
    def test_05_empty_get_match_odds_link_1_file_is_false(self):
    ...
    def test_06_empty_ids_for_tag_span_link_1_file_is_false(self):
        file_link = self.base_dir + '/games_odds/williamHillFiles/tag_name_span_attr_ids/ids_for_tag_span_link_1.csv'
        get_file_size = self.check_file_not_empty(file_link)
        self.assertTrue(get_file_size)

    def test_07_empty_ids_for_tag_tbody_link_1_file_is_false(self):
