...
This is testing the refresh_no sent, sending 1 and emptying a file -> get_match_odds_link_2.csv
Then refresh page with refresh_no 1
'''

class Wh2TestingWilliamHillDeleteOneCsvFile1(TestCase, MainViewsApi, WilliamHillBase, ScrapingWilliamHill):
    def setUp(self):
    ...
    def test_02_william_hill_view_as_200_and_refresh_no_is_1(self):
        request = self.factory.get(reverse('william_hill_2', args=[1]))
