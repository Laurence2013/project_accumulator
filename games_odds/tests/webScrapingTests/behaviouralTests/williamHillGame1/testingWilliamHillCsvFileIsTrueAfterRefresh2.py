...
'''
This is testing no 3b
This is testing the refresh_no sent, sending 1 and get_match_odds_link_0.csv and ids_for_tag_span_link_1.csv are not empty after refresh
'''

class TestingWilliamHillCsvFileIsTrueAfterRefresh2(TestCase, MainViewsApi):
    def setUp(self):
