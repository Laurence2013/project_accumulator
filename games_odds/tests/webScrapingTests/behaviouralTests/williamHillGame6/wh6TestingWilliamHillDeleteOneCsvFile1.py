...
This is testing the refresh_no sent, sending 1 and emptying a file -> get_match_odds_link_6.csv
Then refresh page with refresh_no 1
'''

class Wh6TestingWilliamHillDeleteOneCsvFile1(TestCase, MainViewsApi, WilliamHillBase, ScrapingWilliamHill):
    def setUp(self):
