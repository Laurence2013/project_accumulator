...
class TestingWilliamHillDeleteOneCsvFile0(TestCase, MainViewsApi, WilliamHillBase, ScrapingWilliamHill):
    def setUp(self):
    ...
    def test_03_empty_get_match_odds_link_0_file_is_false(self):
