...
This is testing the refresh_no sent, sending 1 and emptying three files -> get_match_odds_link_4.csv and ids_for_tag_span_link_4.csv and ids_for_tag_tbody_link_4.csv
Then refresh page with refresh_no 1
'''

class Wh4TestingWilliamHillDeleteThreeCsvFile3(TestCase, MainViewsApi, WilliamHillBase, ScrapingWilliamHill):
    def setUp(self):
    ...
    def test_03_empty_2b_file_is_true(self):
        my_file = list()
        get_match_odds_link_1 = self.base_dir + '/games_odds/williamHillFiles/tag_name_tbody_attr_ids/ids_for_tag_tbody_link_4.csv'
        my_file.append(get_match_odds_link_1)
        is_empty_file = self.empty_files(my_file)
        self.assertTrue(is_empty_file)
    ...
    def test_07_empty_ids_for_tag_tbody_link_2_file_is_false(self):
        file_link = self.base_dir + '/games_odds/williamHillFiles/tag_name_tbody_attr_ids/ids_for_tag_tbody_link_4.csv'
        get_file_size = self.check_file_not_empty(file_link)
        self.assertTrue(get_file_size)
